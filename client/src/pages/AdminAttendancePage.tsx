  ...
  return (
    <div style={{ padding: '40px' }}>
      ...
      <header style={{ marginBottom: '40px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '8px' }}>Attendance Monitoring</h1>
          <p style={{ color: 'var(--text-muted)' }}>Track employee check-ins, check-outs, and live locations.</p>
        </div>
        <div style={{ display: 'flex', gap: '16px' }}>
          ...
          <button 
            ...
            style={{ padding: '10px', borderRadius: '10px', backgroundColor: 'var(--surface)', border: '1px solid var(--border)', cursor: 'pointer', color: 'var(--text-main)' }}
            title="Refresh Data"
          >
            <Activity size={18} />
          </button>
